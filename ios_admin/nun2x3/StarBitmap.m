...
- (NSData *)getImageDataForPrinting:(BOOL)compressionEnable
{
	...
	imageData = [[NSData alloc] initWithBytes:data.mutableBytes length:data.length]; //release
...
//                                  0x1b, 0x57, 0x00, 0x00, 0x00, 0x00, mWidth % 256, mWidth / 256,  height       % 256,  height       / 256,
	...
	imageData = [[NSData alloc] initWithBytes:someData.mutableBytes length:someData.length]; //release
