...
struct CozyLoadingActivity {
    ...
    struct Settings {
        ...
        static var CLAFontName = "Roboto"
        // Other possible stuff: ✓ ✓ ✔︎ ✕ ✖︎ ✘
        static var CLASuccessIcon = "✔︎"
        static var CLAFailIcon = "✘"
        static var CLASuccessText = "Exito"
        static var CLAFailText = "Error"
    ...
    private class LoadingActivity: UIView {
        ...
        convenience init(text: String, disableUI: Bool) {
            ...
            self.init(frame: CGRect(x: screenWidth/2 - width/2, y: screenHeight/2 - height/2, width: width, height: height))
